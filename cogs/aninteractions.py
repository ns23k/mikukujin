...
class API:
    ...
    def _base_request(self, endpoint: str) -> str:
...
class AnInteraction(commands.Cog):
    ...
    def create_embed(self, ctx: commands.Context, title, name, url):
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is {title}",
            description=f"{name}",
